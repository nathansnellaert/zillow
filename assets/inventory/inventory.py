"""Fetch and process Zillow Inventory data"""
...
def process_inventory():
    """Process Zillow Inventory data"""
    import pandas as pd
    from io import StringIO
    
    # Load state
    state = load_state("inventory")
    
    # Fetch data
    csv_data = fetch_inventory()
    ...
    # Convert to integer for inventory count
